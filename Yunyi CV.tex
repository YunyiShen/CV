...
\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
	...
	Ê Ê Ê Ê& Detecting phylogenetic signals from spatial coexistence and phylogeny data using phylologistic type model.
\end{tabularx}
...
\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
	...
	$[4]$ & Xiaoyun Shi, \textbf{Yunyi Shen} and Sheng Li "Mapping the current distribution of chrysolophus pheasants (\textit{C. pictus} and \textit{C. amherstiae}) to determine the range of potential hybridization" (\textit{in prep})
